...
summary(lm(log(销售数量.x) ~ avg_price.x + num_item.x  + likes.x + saved  , data = weibo_xiaohongshu_6_8_high))
...
summary(lm(log(销售数量.x) ~ avg_price.x + num_item.x  + likes.x + saved  , data = weibo_xiaohongshu_6_8_cheap))
```
